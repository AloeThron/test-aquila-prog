...
export default function Footer() {
  return (
    <footer className="container mx-auto">
      <div className="flex flex-col md:flex-row items-center gap-[10px] md:justify-between px-14 pt-[40px] pb-[80px] md:pb-[24px]">
        <div className="flex flex-col gap-[12px] md:flex-row items-center">
          ...
          <h4 className="text-[14px] md:w-40 font-medium">© Oli Harris 2023</h4>
        </div>
        <div className="flex gap-[15px] text-[14px]">
          <h4 className="hover:text-black/50 cursor-pointer font-medium">Twitter</h4>
          <h4 className="hover:text-black/50 cursor-pointer font-medium">LinkedIn</h4>
          <h4 className="hover:text-black/50 cursor-pointer font-medium">Mail</h4>
        </div>
      </div>
    </footer>
  );
